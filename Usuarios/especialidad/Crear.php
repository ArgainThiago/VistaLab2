...
if (!empty($ID_Especialidad)&& !empty($Nom_Especialidad)&& !empty($Cedula_D)&& !empty($Descripcion)){
    $sql = "INSERT INTO especialidad (ID_Especialidad,Nom_Especialidad, Cedula_D, Descripcion, Fecha_Esp) VALUES ('$ID_Especialidad', '$Nom_Especialidad', '$Cedula_D','$Descripcion','$Fecha_Esp')";
...
<form method="POST" action="">
    ...
    ID_Especialidad: <input Type="number" name="ID_Especialidad"><br>
    Nom_Especialidad: <input Type="text" name="Nom_Especialidad"><br>
    Cedula_D: <input Type="number" name="Cedula_D"><br>
    Descripcion: <input Type="text" name="Descripcion"><br>
    Fecha_Esp: <input Type="date" name="Fecha_Esp"><br>
